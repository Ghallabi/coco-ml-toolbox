...
from coco_tools.utils import check_is_json
import argparse
...
def parse_args():
    ...
    parser_split.add_argument("--coco-path", required=True, type=str, help="Path to coco file")
    parser_split.add_argument("--output-dir", required=False, type=str, help="Path to save split coco files")
    parser_split.add_argument("--ratio", type=int, default=0.2, help="Split ratio - default to 0.2")
    parser_split.add_argument("--mode", type=str, default="random", help="Should one of the following: random, strat_single_obj or strat_multi_obj")
    ...
    parser_merge.add_argument("--output-dir", type=str, required=False, help="Path where to save merged coco file")
